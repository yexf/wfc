...
RESOBJS := ./resources/win/cefclient.res
INLIBS := -lcef_dll_wrapper ../shared/libshared.a -lcomctl32 -lrpcrt4 -lshlwapi -lws2_32 -lglu32 -limm32 -lopengl32 -loleacc -ldbghelp -lpsapi -lversion -lwinmm 
